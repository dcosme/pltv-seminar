...
`info_links` = Clicked on one or more links to get more information

* Pennvotes.org
* Join the PLTV mailing list

`invovement_links` = Clicked on one or more links to get involved
...
For all of these models, the differences between the control messages and the experimental messages are not statistically significant. There is some evidence that the control messages had higher click rates, but because these differences are so small, they probably just due to chance.
